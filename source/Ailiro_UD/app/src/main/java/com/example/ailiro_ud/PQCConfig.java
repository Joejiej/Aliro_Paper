...
/**
 * Global configuration for PQ-Aliro (User Device side).
...
public final class PQCConfig {
    ...
    /**
     * COSE Algorithm identifier for ML-DSA (IANA COSE Algorithms registry).
     *   ML-DSA-44 (Dilithium2) → -48
     *   ML-DSA-65 (Dilithium3) → -47
     *   ML-DSA-87 (Dilithium5) → -46
     */
    public static int coseAlgorithmId() {
        switch (DILITHIUM_LEVEL) {
            case 2: return -48;
            case 3: return -47;
            case 5: return -46;
    ...
    /** BouncyCastle ASN.1 OID for the active Dilithium parameter set. */
    public static ASN1ObjectIdentifier dilithiumOid() {
        switch (DILITHIUM_LEVEL) {
            case 2: return BCObjectIdentifiers.dilithium2;
            case 3: return BCObjectIdentifiers.dilithium3;
            case 5: return BCObjectIdentifiers.dilithium5;
            default: throw new IllegalStateException("Unsupported DILITHIUM_LEVEL: " + DILITHIUM_LEVEL);
        }
    }
